      ...
      {activeTab === 'cameras' && (
        <>
          ...
          <div className="bg-[#1E1E1E] p-4 rounded-[3px] shadow-lg space-y-4">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 pb-3 border-b border-[#A0A0A0]/20">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2 bg-[#151515] p-2.5 rounded-[3px] text-xs mb-3 font-heading">
                      ...
                      <div className="col-span-2 pt-1 border-t border-[#A0A0A0]/20 truncate">
                  ...
                  {/* Card Actions */}
                  <div className="flex items-center gap-2 pt-2 border-t border-[#A0A0A0]/20">
                    <button
      ...
      {modalCamera && (
        <div className="fixed inset-0 z-50 bg-[#000000]/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#1E1E1E] rounded-[3px] w-full max-w-2xl overflow-hidden shadow-2xl space-y-4">
            {/* Modal Header */}
            <div className="bg-[#151515] px-5 py-4 border-b border-[#A0A0A0]/20 flex items-center justify-between">
              <div>
            ...
            <div className="px-5 space-y-4 max-h-[65vh] overflow-y-auto font-heading">
              ...
              <div className="pt-2 border-t border-[#A0A0A0]/20">
            ...
            {/* Modal Footer */}
            <div className="bg-[#151515] px-5 py-3 border-t border-[#A0A0A0]/20 flex items-center justify-end gap-3 font-heading">
              <button
                onClick={() => setModalCamera(null)}
      ...
      {previewData && (
        <div className="fixed inset-0 z-50 bg-[#000000]/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#1E1E1E] rounded-[3px] w-full max-w-3xl overflow-hidden shadow-2xl space-y-4">
            ...
            <div className="bg-[#151515] px-5 py-3 border-t border-[#A0A0A0]/20 flex items-center justify-between font-heading">
